...
public class PuzzleView extends RelativeLayout {
    ...
    private int startY; // starts y coordinate of TextView being moved
    private int startTouchY; // starts y coordinate of current touch
    ...
    // Returns the index of tv within the tvs array
    ...
    // returns index of TextView with y as the location
    ...
    // replaces text inside tvIndex TextView with s
